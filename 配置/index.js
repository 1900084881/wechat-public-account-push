export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx633863975a1621c8",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c596d26465d90d5a1117e19766969919",
  ...
  USERS: [
    {
      ...
      id: "obZwy6X7MN6xf7-j_jNjATRc5x0Y",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "KG6Q4hzWYvAXHU526sMF-bhxIS9xPmA7r1NbYdUV_dw	",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "惠州",
